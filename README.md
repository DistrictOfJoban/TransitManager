...
Available for Minecraft Fabric 1.20.4, port to older versions are planned in the future.
...
| /train dwell reset                                              | This resets the dwell time back to 0.<br>Useful for extending the dwell time.                                                                                                                                 | OP Level 2       |
| /train dwell skip                                               | This skips the dwell time for the nearest train.<br>If the train is boarding, it will depart shortly after the door closes.<br>Otherwise, it will skip the dwell time in the next stop like a Turn Back Rail. | OP Level 2       |
| /train dwell set <New Elapsed Time Milliseconds>                | This sets the dwell time to a specific time in milliseconds.<br>Useful for precise control of dwell time.                                                                                                     | OP Level 2       |
| /tsc ping                                                       | This measures the response time of Transport Simulation Core, given in millisecond. For diagnosing TSC performance only.                                                                                      | OP Level 2       |
| /tsc freeze                                                     | This toggle simulation freeze of current dimension of Transport Simulation Core. For debugging only.                                                                                                          | OP Level 2       |
